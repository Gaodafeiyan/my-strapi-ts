...
async function testNewReferralSystem() {
  try {
    ...
    // 6. 测试场景2：邀请人投资500U，被邀请人投资1000U（锁档）
    log('6. 测试场景2：邀请人投资500U，被邀请人投资1000U（锁档）');
    await testScenario2();

    // 7. 测试场景3：邀请人投资1000U，被邀请人投资1000U
    log('7. 测试场景3：邀请人投资1000U，被邀请人投资1000U');
    await testScenario3();

    // 8. 测试场景4：邀请人投资2000U，被邀请人投资500U
    log('8. 测试场景4：邀请人投资2000U，被邀请人投资500U');
    await testScenario4();
...
async function testScenario2() {
  ...
  log('场景2结果', {
    expected: '0 USDT (锁档：邀请人500U < 被邀请人1000U)',
...
async function testScenario4() {
  ...
  log('场景4结果', {
    expected: '24 USDT (80% of 30 USDT static profit)',
    actual: referralRewards.data.length > 0 ? `${referralRewards.data[referralRewards.data.length - 1].amountUSDT} USDT` : '0 USDT'
  });
}
...
module.exports = { testNewReferralSystem }; 