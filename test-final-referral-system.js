...
// 测试步骤
async function testFinalReferralSystem() {
  try {
    log('🚀 开始测试最终的锁档推荐奖励制度');
    ...
    const inviterResponse = await api.post('/auth/local/register', {
      username: 'inviter_final',
      email: 'inviter_final@test.com',
      password: '123456',
      referralCode: 'TESTFINAL001'
    });
    ...
    const inviteeResponse = await api.post('/auth/local/register', {
      username: 'invitee_final',
      email: 'invitee_final@test.com',
      password: '123456',
    ...
    // 5. 测试场景1：邀请人投资500U，被邀请人投资500U
    log('5. 测试场景1：邀请人投资500U，被邀请人投资500U');
    await testScenario1();

    // 6. 测试场景2：邀请人投资500U，被邀请人投资5000U（超出部分燃烧）
    log('6. 测试场景2：邀请人投资500U，被邀请人投资5000U（超出部分燃烧）');
    await testScenario2();

    // 7. 测试场景3：邀请人投资1000U，被邀请人投资2000U（超出部分燃烧）
    log('7. 测试场景3：邀请人投资1000U，被邀请人投资2000U（超出部分燃烧）');
    await testScenario3();

    // 8. 测试场景4：邀请人投资5000U，被邀请人投资500U
    log('8. 测试场景4：邀请人投资5000U，被邀请人投资500U');
    await testScenario4();

    // 9. 测试场景5：邀请人投资5000U，被邀请人投资5000U
    log('9. 测试场景5：邀请人投资5000U，被邀请人投资5000U');
    await testScenario5();
...
if (require.main === module) {
  testFinalReferralSystem();
}

module.exports = { testFinalReferralSystem }; 